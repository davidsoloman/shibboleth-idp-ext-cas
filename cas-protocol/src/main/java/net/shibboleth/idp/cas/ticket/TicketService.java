...
public interface TicketService {
     ...
     */
    @Nonnull ServiceTicket createServiceTicket(@Nonnull String sessionId, @Nonnull String service, boolean renew);
     ...
     */
    @Nonnull ProxyGrantingTicket createProxyGrantingTicket(@Nonnull ServiceTicket serviceTicket, @Nonnull String pgtId);
     ...
     * @return Created proxy-granting ticket.
     */
    @Nonnull ProxyGrantingTicket createProxyGrantingTicket(@Nonnull ProxyTicket proxyTicket, @Nonnull String pgtId);
